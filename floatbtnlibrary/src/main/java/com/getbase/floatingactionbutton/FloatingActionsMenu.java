...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        post(new Runnable() {
            ...
            @Override
            public void run() {
                showPosition = ViewHelper.getY(FloatingActionsMenu.this) - Utils.dpToPx(24, getResources());
                hidePosition = ViewHelper.getY(FloatingActionsMenu.this) + mAddButton.getHeight() * 3;
                ViewHelper.setY(FloatingActionsMenu.this, showPosition);
                FloatingActionsMenu.this.setVisibility(VISIBLE);
//                show();
            }
        });
    }
    ...
    public void show() {
        com.nineoldandroids.animation.ObjectAnimator animator = com.nineoldandroids.animation.ObjectAnimator.ofFloat(FloatingActionsMenu.this, "y", showPosition);
    ...
    public void hide() {
        com.nineoldandroids.animation.ObjectAnimator animator = com.nineoldandroids.animation.ObjectAnimator.ofFloat(FloatingActionsMenu.this, "y", hidePosition);
        animator.setInterpolator(new BounceInterpolator());
        animator.setDuration(1500);
        animator.start();
    ...
    private void createAddButton(Context context) {
        ...
        FloatingActionsMenu.this.setVisibility(INVISIBLE);
    }
