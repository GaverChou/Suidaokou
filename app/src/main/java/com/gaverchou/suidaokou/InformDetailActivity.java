...
public class InformDetailActivity extends BaseActivity implements ObservableScrollViewCallbacks {
    ...
    protected void initView() {
        ...
        String test = "<table border=\"0\" class=\"winstyle53824\" width=\"100%\" cellspacing=\"0\" cellpadding=\"0\">\n" +
                ...
                "            <script language=\"javascript\" src=\"../../system/resource/js/ajax.js\"></script><span class=\"clickstyle53824\">&nbsp;&nbsp;(点击： <span id=\"n44973\">278</span>)</span><script language=\"javascript\">getClickTimes('44973','919160919','wbnews','')</script>\n" +
                "        </td></tr>\n" +
                "        <tr><td align=\"right\">\n" +
                "        <span>\n" +
                "\n" +
                ...
                "\n" +
                "      <tr><td align=\"right\">\n" +
                "<table><tbody><tr><td class=\"contextstyle53824\">已是首条</td></tr><tr><td class=\"contextstyle53824\"><a href=\"44963.htm\"><span class=\"contextstyle53824\">下一条：广东外语外贸大学2015年“创客领航计划”启动仪式暨“广外创客讲坛”第一讲订票通知</span></a></td></tr></tbody></table>              <span>【</span><a href=\"javascript:window.opener=null;window.open('','_self');window.close();\"><span>关闭窗口</span></a><span>】</span>\n" +
                "      </td></tr>\n" +
                "\n" +
                "</tbody></table>";
        headActContentWebView.loadData(test, "text/html; charset=UTF-8", null);
        bgView = headView.findViewById(R.id.headview_divide_panel);
        bgView.setBackgroundColor(colorArr[pos%colorArr.length]);
