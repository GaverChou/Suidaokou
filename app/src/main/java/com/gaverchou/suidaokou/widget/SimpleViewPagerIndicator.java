...
public class SimpleViewPagerIndicator extends LinearLayout {
	...
	private int inditorColor = 0x55f9f9f9;
	...
	public SimpleViewPagerIndicator(Context context, AttributeSet attrs) {
		...
		mPaint.setStrokeWidth(DensityUtil.dip2px(context, 4.0F));
	}
	...
	public SimpleViewPagerIndicator(Context context, AttributeSet attrs,
		...
		for (int i = 0; i < n; i++) {
			...
			case R.styleable.Indicator_indicatorColor:
				...
				break;
			case R.styleable.Indicator_textColor:
				textColor = arr.getInteger(attr, 0xFF000000);
				break;
			}
		}
		arr.recycle();
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		canvas.save();
		canvas.translate(mTranslationX, getHeight() - DensityUtil.dip2px(getContext(), 2));
