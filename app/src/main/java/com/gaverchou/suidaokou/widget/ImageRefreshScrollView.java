...
import com.gaverchou.observablescrollview.ObservableScrollView;
import com.gaverchou.suidaokou.util.TouchTool;

/**
 * Created by GaverChou on 2015-06-05.
 */
public class ImageRefreshScrollView extends ObservableScrollView {
    public ImageRefreshScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public ImageRefreshScrollView(Context context, AttributeSet attrs, int defStyle) {
